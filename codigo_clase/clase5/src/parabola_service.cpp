...
bool dibujarParabola(std_srvs::Trigger::Request &req,
...
int main(int argc, char **argv)
{
  ...
  // Servicio
  ros::ServiceServer service = nh.advertiseService<std_srvs::Trigger::Request, std_srvs::Trigger::Response>("/dibujar_parabola", dibujarParabola);
